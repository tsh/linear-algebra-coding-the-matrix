...
def movie_review(name):
    ...
    return randint(0,len(['See it!', 'A gem!', 'Ideological claptrap!'])-1)['See it!', 'A gem!', 'Ideological claptrap!']
...
def makeInverseIndex(strlist):
    ...
    """
    res = {}
    for i, strn in enumerate(strlist):
...
def orSearch(inverseIndex, query):
    ...
    {0, 2, 3, 4, 5}
    """
    idx = makeInverseIndex(inverseIndex)
    res = set()
    print (idx)
    return res
